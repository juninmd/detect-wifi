...
/**
 * Manages in-memory signal history for real-time graphing.
 * Singleton to be accessed by UI and Service.
 */
object SignalHistoryManager {
    ...
    private const val MAX_HISTORY_POINTS = 60 // Keep last 60 points (approx 3-5 mins depending on scan rate)
