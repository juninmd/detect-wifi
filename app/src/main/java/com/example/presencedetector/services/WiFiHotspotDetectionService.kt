...
/**
 * WiFi Hotspot detection service - detects mobile devices sharing WiFi.
 * Complements WiFiDetectionService with advanced hotspot recognition.
 */
class WiFiHotspotDetectionService(private val context: Context) {
    ...
    private suspend fun performScan() {
        try {
            ...
            // Update count
            mainHandler.post {
                hotspotListener?.onHotspotsUpdated(detectedHotspots.size)
            }
