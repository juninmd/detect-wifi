...
class LogRepositoryTest {
  ...
  fun `logSystemEvent should create file and append log`() {
    ...
    val logFile =
      File(context.getExternalFilesDir(null), "presence_detector_logs/system_events.log")
  ...
  fun `logDetectionEvent should create specific file`() {
    ...
    val logFile =
      File(context.getExternalFilesDir(null), "presence_detector_logs/device_${safeBssid}.log")
    assertTrue(logFile.exists())
  }
